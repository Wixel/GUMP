...
class GUMP
{
    ...
    */
    ...
    protected function validate_alpha($field, $input, $param = null)
    {
        ...
        if (!preg_match('/^([\p{L}])+$/u', $input[$field]) !== false) {
            return array(
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_alpha_numeric($field, $input, $param = null)
    {
        ...
        if (!preg_match('/^([\p{N}\p{L}])+$/u', $input[$field]) !== false) {
            return array(
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_alpha_dash($field, $input, $param = null)
    {
        ...
        if (!preg_match('/^([\p{N}\p{L}_-])+$/u', $input[$field]) !== false) {
            return array(
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
    ...
    protected function validate_alpha_space($field, $input, $param = null)
    {
        ...
        if (!preg_match("/^([\p{N}\p{L}\s])+$/u", $input[$field]) !== false) {
            return array(
                'field' => $field,
                'value' => $input[$field],
                'rule' => __FUNCTION__,
