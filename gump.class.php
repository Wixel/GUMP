...
class Gump {
	...
	/**
	 * Process the validation errors and return human readable error
	 * messages
	 *
	...
	/**
	 * Sanitize the string by converting HTML characters to their HTML
	 * entities
	 *
	...
	/**
	 * Verify that a value is contained within the pre-defined value
	 * set
	 *
	...
	/**
	 * Determine if the provided value length is less or equal to a
	 * specific value
	 *
	...
	/**
	 * Determine if the provided value length is more or equal to a
	 * specific value
	 *
	...
	/**
	 * Determine if the provided value is a valid number or numeric
	 * string
	 *
	 * Usage: '<index>' => 'numeric'
	 *
	...
	protected function validate_url_exists($field, $input, $param = NULL) {
		...
		$url = str_replace(array('http://', 'https://', 'ftp://'), '', strtolower($input[$field]));
	...
	/**
	 * Determine if the input is a valid human name [Credits to
	 * http://github.com/ben-s]
	 *
	...
	/**
	 * Determine if the provided input is likely to be a street
	 * address using weak detection
	 *
